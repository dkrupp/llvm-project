...
void test_sprintf() {
  ...
  // CHECK-MESSAGES: :[[@LINE-1]]:3: warning: format specifier '%s' is unsafe without field width constraint; consider using '%99s' or snprintf [bugprone-unsafe-format-string]
